...
$LOGIN_INFORMATION = array(
  $manage_username => $manage_password
);
...
<?php if (USE_USERNAME) echo 'Username:<br /><input type="input" name="access_login" /><br />Password:<br />'; ?>
  ...
  <p>If you have any trouble logging into this utility, please email <a href="mailto:aj3401@wayne.edu">Matt Wisotsky</a>.</p>
  </div>
</body>
</html>
